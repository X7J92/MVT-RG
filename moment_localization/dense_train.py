...
#         prediction, map_mask,  logit_scale, sims2, logit_scale2,  logit_scale3,jj, weight_3, words_logit, ids_list, weights, words_mask1,vg_hs_video,vg_hs_t, batch_output_tensor= model(
...
#         rank1, rank5, rank10, rank100 = calculate_sentence_rank_accuracy(sorted_text_list_tensor,
...
if __name__ == '__main__':
    ...
    def on_test_end(state):
        ...
        rank1, rank5, rank10, rank100 = calculate_sentence_rank_accuracy_mean(sorted_video_layer_list_tensor,
                                                                              ...
                                                                              sorted_video_id_list_all,
                                                                              sorted_sentence_number_list_tensor)
        logger.info(f'Rank-1 Accuracy: {rank1:.4f}')
        logger.info(f'Rank-5 Accuracy: {rank5:.4f}')
        logger.info(f'Rank-10 Accuracy: {rank10:.4f}')
        logger.info(f'Rank-100 Accuracy: {rank100:.4f}')
        ...
        rank1_c, rank5_c, rank10_c, rank100_c = calculate_sentence_rank_accuracy(sorted_text_list_tensor,
                                                                                 ...
                                                                                 sorted_video_id_list_all,
                                                                                 sorted_sentence_number_list_tensor)
        logger.info(f'Rank-1 Accuracy: {rank1_c:.4f}')
        logger.info(f'Rank-5 Accuracy: {rank5_c:.4f}')
        logger.info(f'Rank-10 Accuracy: {rank10_c:.4f}')
        logger.info(f'Rank-100 Accuracy: {rank100_c:.4f}')
        ...
        rank1_acc, rank5_acc, rank10_acc, rank100_acc = calculate_sentence_rank_accuracy_with_grounding(
            sorted_text_list_tensor, sorted_video_list_tensor_25, sorted_video_id_list_all_25, sorted_video_id_list_all,
            sorted_sentence_number_list_tensor, grounding_mask)
        logger.info(f'Rank-1 Accuracy at IOU=0.3, 0.5, 0.7: {rank1_acc}')
        logger.info(f'Rank-5 Accuracy at IOU=0.3, 0.5, 0.7: {rank5_acc}')
        logger.info(f'Rank-10 Accuracy at IOU=0.3, 0.5, 0.7: {rank10_acc}')
        logger.info(f'Rank-100 Accuracy at IOU=0.3, 0.5, 0.7: {rank100_acc}')
